...
class Hospitalizations extends Model {
    ...
    */
    ...
    protected $fillable = [ 
                        ...
                        'hospitalization_how_many',
                        'hospitalization_why',
                        'hospitalization_respiratory',
                        'hostpitalization_cardiac_myocardial_infarction',
                        'resource_type',
                        'ip_address',
     ...
     */
    public function getPatientHospitalizationsInfo($visitId, $patientId = '', $encrypt = true) 
    {
        $selectData = [
                    'hospitalization_id',
                    'pat_id',
        ...
        $queryResult = $this->dbBatchSelect($this->table, $selectData, $whereData);
            if($encrypt && !empty($queryResult)){
                ...
                $dataList->hospitalization_id        = $this->securityLibObj->encrypt($dataList->hospitalization_id);
    ...
    */
    public function updatePatientHospitalizationsInfo($requestData, $whereData)
    {
        if(!empty($whereData)){
    ...
    * @return                Array of status and message
    */
    public function addPatientHospitalizationsInfo($insertData)
    {
