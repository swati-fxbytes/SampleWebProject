...
class CreateTablePatientPulmonaryFunctionTest extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('patient_pulmonary_function_test')) {
            Schema::create('patient_pulmonary_function_test', function (Blueprint $table) {
                $table->increments('pft_id')->comment('Primary key patient_pulmonary_function_test table');
                ...
                $table->tinyInteger('pulmonary_function_test_status')->nullable()->comment('1 for yes, 2 for no');
