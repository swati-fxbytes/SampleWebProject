...
class TreatmentRequirement extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('treatment_requirement')) {
            Schema::create('treatment_requirement', function (Blueprint $table) {
                $table->increments('treatment_requirement_id')->comment('Treatment requirement id');
                ...
                $table->integer('fector_id')->unsigned()->nullable()->comment('Treatment requirement fector id');
                $table->string('fector_value',255)->nullable()->comment('Treatment requirement fector value');
