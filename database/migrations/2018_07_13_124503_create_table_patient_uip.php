...
class CreateTablePatientUip extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
         if (!Schema::hasTable('patient_uip')) {
            Schema::create('patient_uip', function (Blueprint $table) {
                $table->increments('puip_id')->comment('Primary key patient_uip table');
                ...
                $table->tinyInteger('puip_is_happen')->nullable()->comment('HRCT detail report');
    ...
    {
         Schema::dropIfExists('patient_uip');
    }
}
