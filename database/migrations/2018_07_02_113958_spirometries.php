...
class Spirometries extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('spirometries')) {
            Schema::create('spirometries', function (Blueprint $table) {
                $table->increments('spirometry_id')->comment('Spirometry ID');
                ...
                $table->date('spirometry_date')->nullable()->comment('Date of spirometry');
