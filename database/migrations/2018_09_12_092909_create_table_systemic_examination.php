...
class CreateTableSystemicExamination extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::hasTable('systemic_examination')) {
            Schema::create('systemic_examination', function (Blueprint $table) {
                $table->increments('systemic_exam_id')->unsigned()->comment('Systemic examination unique id');
                ...
                $table->integer('systemic_exam_type')->comment('systemic_exam_type from static config data');
                $table->integer('systemic_exam_type_id')->comment('systemic_exam_type_id from static config data');
                $table->string('systemic_exam_value',255)->nullable()->comment('systemic_exam_value ');
    ...
    {
        Schema::dropIfExists('systemic_examination');
    }
}
