                                ...
                                <tbody>
                                    <tr>
                                        <td bgcolor="#ffffff" style="padding:35px 30px 25px">
                                            <h1 style="color:#445361;font-family:'Trebuchet MS',Arial,sans-serif;font-size:20px;line-height:24px;font-weight:bold;margin:0 0 25px;Margin:0 0 25px">Hello {{$emailDetail['patientDetail']->user_firstname}} {{$emailDetail['patientDetail']->user_lastname}},</h1> 
                                            ...
                                            Your appointment to <b>Dr. {{$emailDetail['doctorDetail']->user_firstname}} {{$emailDetail['doctorDetail']->user_lastname}}</b> has been booked successful for <b>{{$emailDetail['bookingDetail']->booking_date}}</b>. Please login to your {{$app_name}} account for more details.
                                            </p>

                                            <p style="color:#445361;font-family:'Trebuchet MS',Arial,sans-serif;font-size:14px;line-height:24px;margin:0 0 25px;Margin:0 0 25px">
                                            <b>Note:</b> Please visit the clinic 10 minutes before the scheduled appointment.
                                            </p>
