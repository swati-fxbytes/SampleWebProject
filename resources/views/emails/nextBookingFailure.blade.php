                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0"><tbody>
                        <tr><td align="center">
                            <table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff" >
                                <tbody>
                                    <tr>
                                        <td valign="top" style="border-bottom: 1px solid #eaeaea; padding-bottom: 10px;"><img src="{{$app_url}}/public/images/Rxlogo.png" width="150" height="80" alt=""/></td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <tr>
                                        <td bgcolor="#ffffff" style="padding:35px 30px 25px">
                                            ...
                                            <p style="color:#445361;font-family:'Trebuchet MS',Arial,sans-serif;font-size:14px;line-height:24px;margin:0 0 25px;Margin:0 0 25px">
                                                Next booking schedule is not booked due to unavailability of booking slots. You may create booking schedule manually for following patient:<br/>
                                                <b>Patient Name: {{$emailDetail['patientDetail']->user_firstname}} {{$emailDetail['patientDetail']->user_lastname}}</b><br/><b>Registration No: {{$emailDetail['patientDetail']->pat_code}}</b>
                                            </p>
